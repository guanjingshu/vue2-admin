<template>
    ...
    <div slot="reference" class="rowstart aligncenter">
        ...
        :style="this.focus_style">
            <div class="rowstart">
                <div v-if="checkData.length > 0" class="rowstart aligncenter">
                    <div class="tag rowbetween aligncenter">
                        ...
                        <img class="size8" :src="require('@/assets/images/icon-close.png')" @click.stop.prevent="actionDeleteTag(checkedData[0])"/>
                    </div>
                    <div v-if="checkedData.length > 1" class="num">{{ checkedData.length }}</div>
                </div>
                <el-input
                @foucus="onInputFocus"
                @blur="onInputBlur"
            ...
            style="color:#191919;opacity:0.4"></i>
            <i
